...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r starter-node-angular-temp/* starter-node-angular-1/ && rm -rf starter-node-angular-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd starter-node-angular-1 && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
